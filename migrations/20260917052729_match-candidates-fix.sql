-- Harden list_match_candidates: return jsonb rows (stable PostgREST shape).
...
COMMENT ON FUNCTION public.list_match_candidates() IS
  'Authenticated Match catalog as jsonb rows. Excludes caller. Never returns email/WhatsApp.';
